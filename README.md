...
![](docs/assets/home-server.svg) = on Casa (home server) · ![](docs/assets/vps-server.svg) = on Racknerd VPS
![](docs/assets/badge-inhouse.svg) = built in-house · ![](docs/assets/badge-thirdparty.svg) = third-party OSS
![](docs/assets/docker.svg) = Docker container · ![](docs/assets/systemd.svg) = system-wide service · ![](docs/assets/other.svg) = other

- **[Nextcloud](https://github.com/nextcloud/server)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
...
- **[Immich](https://github.com/immich-app/immich)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
...
- **[Memos](https://github.com/usememos/memos)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- My choice of note app: lightweight note-taking, simple and adaptable. 
	- Runs as a single container.
- **[Vaultwarden](https://github.com/dani-garcia/vaultwarden)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Alternative to Bitwarden: password manager, works with the official Bitwarden apps, but in rust so lighter. 
	- Runs as a single container.
- **[Obsidian LiveSync](https://github.com/vrtmrz/obsidian-livesync)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Self hosted Obsidian Sync: syncs my Obsidian notes across devices
	- Backed by a CouchDB database container.
	- Containers: CouchDB
- **[Open WebUI](https://github.com/open-webui/open-webui)** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Alternative to ChatGPT: self-hosted AI chat/agent interface
	- Runs as a single container, with models routed through New API.
- **[New API](https://github.com/QuantumNous/new-api)** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Aggregator for different LLM APIs: API keys, model routing, and usage tracking for the AI services
	- Runs as a single container.
- **[Uptime Kuma](https://github.com/louislam/uptime-kuma)** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Uptime monitoring and status pages, also used in Vigyl for alert for status updates
	- Runs as a single container.
- **[Vigyl](https://github.com/Peteryhs/Vigyl)** ![](docs/assets/home-server.svg) ![](docs/assets/other.svg) ![](docs/assets/badge-inhouse.svg)
...
- **[Memos MCP](https://github.com/ShaoRou459/memos-mcp)** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-inhouse.svg)
	- MCP server: gives AI agents read/write access to my Memos db. 
	- Runs as a single container.
- **[CockpitAgent](https://github.com/ShaoRou459/CockpitAgent)** ![](docs/assets/vps-server.svg) ![](docs/assets/other.svg) ![](docs/assets/badge-inhouse.svg)
...
- **[Watchtower](https://github.com/containrrr/watchtower)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Keeps all Docker images updated automatically
	- Runs as a single container.
- **[Cockpit](https://github.com/cockpit-project/cockpit)** ![](docs/assets/home-server.svg) ![](docs/assets/systemd.svg) ![](docs/assets/badge-thirdparty.svg)
	- Web console for server monitoring and management, hosts Cockpit Agent
	- Runs as a system service.
- **[CrowdSec Agent](https://github.com/crowdsecurity/crowdsec)** ![](docs/assets/home-server.svg) ![](docs/assets/systemd.svg) ![](docs/assets/badge-thirdparty.svg)
	- IP based threat detection that feeds decisions to the edge bouncer
	- Runs as a system service.
- **[CrowdSec Bouncer](https://github.com/crowdsecurity/crowdsec)** ![](docs/assets/vps-server.svg) ![](docs/assets/systemd.svg) ![](docs/assets/badge-thirdparty.svg)
	- Blocks banned IPs in nftables at the internet edge
	- Runs as a system service.
- **[Cloudflared](https://github.com/cloudflare/cloudflared)** ![](docs/assets/home-server.svg) ![](docs/assets/systemd.svg) ![](docs/assets/badge-thirdparty.svg)
	- Cloudflare Tunnel keeping Casa reachable without open ports
	- Runs as a system service.
- **[Cloudflared](https://github.com/cloudflare/cloudflared)** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Same thing as above but for services on the VPS. 
	- Runs as a container.
- **[Caddy](https://github.com/caddyserver/caddy)** ![](docs/assets/home-server.svg) ![](docs/assets/systemd.svg) ![](docs/assets/badge-thirdparty.svg)
	- TLS reverse proxy in front of the services
	- Runs as a system service.
- **[Portainer](https://github.com/portainer/portainer)** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Container management UI for both nodes
	- Runs as a container.
- **[Portainer Agent](https://github.com/portainer/portainer)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Connects Casa's containers to the Portainer UI on VPS. 
	- Runs as a container.
- **[open-terminal](https://github.com/open-webui/open-terminal)** ![](docs/assets/home-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-thirdparty.svg)
	- Open WebUI's terminal tool: sandboxed files, shell, and code execution for the AI
	- Runs as a container.
- **Blind proxy** ![](docs/assets/vps-server.svg) ![](docs/assets/docker.svg) ![](docs/assets/badge-inhouse.svg)
...
![](docs/assets/Network Topology.png)
...
**Cloudflare Tunnels on Casa ![](docs/assets/route-b.svg):** lightweight services that mostly move plain text, like the notes containers (Memos, Obsidian LiveSync), are exposed straight from the origin through Cloudflare tunnels. Deployment is simple: point a domain at a local port and the service is up. Maintenance is easier too, since my domains live on Cloudflare anyway. 
...
![](docs/assets/Cloudflare Tunnel Casa.png)

**VPS Blind Proxy Gateway w/ CrowdSec ![](docs/assets/route-a.svg):** the heavy services take a different road. Inbound traffic goes straight through the custom built Layer 4 blind proxy on the VPS (We have Cloudflare point our domains to the VPS's IP), which forwards it to Caddy on Casa over Tailscale. This bypasses the CF tunnel limits, as the VPS has huge bandwidths with minimal network restrictions.  
...
![](docs/assets/Blind Proxy Path.png)
...
![](docs/assets/CrowdSec Loop.png)

**Cloudflare Tunnels on VPS ![](docs/assets/route-c.svg):** similar story to Casa. The VPS only hosts lightweight services, and they are all exposed directly on the Cloudflare edge through tunnels. 

![](docs/assets/Cloudflare Tunnel VPS.png)
...
| :-------------------------------------------- | :----- | :--- | :---------- | :------------------------------------------- |
| Seagate Ultrastar ![](docs/assets/home-server.svg) | 10.9 T | ext4 | 3% (295G)   | **Hosts live data** (Immich, Nextcloud data) |
| WD HDD ![](docs/assets/home-server.svg)            | 931 G  | ext4 | 30% (256G)  | **Local backup** (borg/Vorta repos)          |
| SanDisk SSD ![](docs/assets/home-server.svg)       | 119 G  | ext4 | 75% (82G)   | OS + Docker + app configs                    |
| KVM SSD Storage![](docs/assets/vps-server.svg)     | 40 G   | ext4 | 73% (29.2G) | Hosts system + Application Data              |
...
- **VPS blind proxy gateway** ![](docs/assets/route-a.svg): the direct road for heavy services 
- **Cloudflare tunnel to Casa** ![](docs/assets/route-b.svg): the road for lightweight Casa services 
- **Cloudflare tunnel to VPS** ![](docs/assets/route-c.svg): the road for lightweight VPS services

### Service Summary

| Service            |             On              |              Built               |         Runs as         | Backed up | Traffic path                                             |
| :----------------- | :-------------------------: | :------------------------------: | :---------------------: | :-------: | :------------------------------------------------------- |
| Nextcloud          | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    Yes    | ![](docs/assets/route-a.svg) Blind proxy                      |
| Immich             | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    Yes    | ![](docs/assets/route-a.svg) Blind proxy                      |
| Memos              | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-b.svg) CF tunnel to Casa                |
| Vaultwarden        | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    Yes    | ![](docs/assets/route-b.svg) CF tunnel to Casa, behind Access |
| Obsidian LiveSync  | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-b.svg) CF tunnel to Casa                |
| Vigyl              | ![](docs/assets/home-server.svg) |  ![](docs/assets/badge-inhouse.svg)   |  ![](docs/assets/other.svg)  |    No     | Local (LCD display)                                      |
| Open WebUI         | ![](docs/assets/vps-server.svg)  | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-c.svg) CF tunnel to VPS                 |
| New API            | ![](docs/assets/vps-server.svg)  | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-c.svg) CF tunnel to VPS                 |
| Uptime Kuma        | ![](docs/assets/vps-server.svg)  | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-c.svg) CF tunnel to VPS                 |
| Memos MCP          | ![](docs/assets/vps-server.svg)  |  ![](docs/assets/badge-inhouse.svg)   | ![](docs/assets/docker.svg)  |    No     | Internal (Tailscale to Casa)                             |
| CockpitAgent       | ![](docs/assets/vps-server.svg)  |  ![](docs/assets/badge-inhouse.svg)   |  ![](docs/assets/other.svg)  |    No     | Local (Cockpit plugin)                                   |
| Watchtower         | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | Local (image updates)                                    |
| Cockpit            | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/systemd.svg) |    No     | Local (management)                                       |
| CrowdSec agent     | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/systemd.svg) |    No     | Local (reads Caddy logs)                                 |
| CrowdSec bouncer   | ![](docs/assets/vps-server.svg)  | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/systemd.svg) |    No     | Internal (Tailscale to LAPI)                             |
| Caddy              | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/systemd.svg) |    No     | Local (origin proxy)                                     |
| Cloudflared (Casa) | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/systemd.svg) |    No     | ![](docs/assets/route-b.svg) Outbound to Cloudflare           |
| Cloudflared (VPS)  | ![](docs/assets/vps-server.svg)  | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-c.svg) Outbound to Cloudflare           |
| Blind proxy        | ![](docs/assets/vps-server.svg)  |  ![](docs/assets/badge-inhouse.svg)   | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-a.svg) The blind proxy route            |
| Portainer          | ![](docs/assets/vps-server.svg)  | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | ![](docs/assets/route-c.svg) CF tunnel to VPS                 |
| Portainer Agent    | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | Internal (Tailscale to Portainer)                        |
| open-terminal      | ![](docs/assets/home-server.svg) | ![](docs/assets/badge-thirdparty.svg) | ![](docs/assets/docker.svg)  |    No     | Internal (Tailscale from Open WebUI)                     |
